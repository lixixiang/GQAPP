...
/**
 * @ProjectName: GQAPP
 * @CreateDate: 2020/4/21 4:04
 * @Author: 李熙祥
 * @Description: java类作用描述 滚动选择器
 */
public class PickerView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        //方法表示我自己的事情我自己处理  然后子ViewPager能够滑动了
        timer = new Timer();
        TypedArray typedArray = null;
        if (attrs != null) {
            typedArray = context.obtainStyledAttributes(attrs, R.styleable.vertical_scroll);
        }
        mColorText = typedArray.getColor(R.styleable.vertical_scroll_textColor, mColorText);
