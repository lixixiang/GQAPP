package com.example.gqapp.widget.button;
...
public class MorphingButton extends AppCompatButton {
    ...
    private void initView() {
        ...
        int cornerRadius = (int) resources.getDimension(R.dimen.mb_corner_radius_100);
        int red = resources.getColor(R.color.red);
        int greedDark = resources.getColor(R.color.green);

        StateListDrawable background = new StateListDrawable();
        mDrawableNormal = createDrawable(red, cornerRadius, 0);
        mDrawablePressed = createDrawable(red, cornerRadius, 0);
